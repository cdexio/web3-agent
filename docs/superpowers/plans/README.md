...
| 2 | [Scanners and route split](phase-2-scanners.md) — **built 2026-09-25**, see [report](phase-2-report.md) | 1 | candidates from all free sources flow into both queues with correct routing, within budgets |
| 3 | [Hard filter and enrichers](phase-3-filter-enrichers.md) — **built 2026-09-25**, see [report](phase-3-report.md) | 2 | every candidate gets a complete, cached enrichment document or an explicit reject reason |
